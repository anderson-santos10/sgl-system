...
from .views import (CenarioExpedicaoView, CenarioCardSeparacaoView,
                    DetalheCardView, CenarioSeparacaoView, CenarioCarregamentoView, EditarSeparacaoView)
...
urlpatterns = [
    ...
    path("separacao/editar/<int:pk>/",EditarSeparacaoView.as_view(),name="editar_separacao")
